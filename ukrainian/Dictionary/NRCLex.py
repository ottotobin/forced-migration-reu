#!/usr/bin/env python
"""
This file comes from NRCLex source code, we had to manually change the lexicon file 
found in the NRCLex class to a custom one 

Our custom json file, 'Ukrainian-NRC-EmoLex.json' was based on an emotion detection dictionary sourced from https://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm

NRCLex code on GitHub: https://github.com/metalcorebear/NRCLex/blob/master/nrclex.py
"""
...
class NRCLex:
    ...
    with open('Ukrainian-NRC-EmoLex.json') as json_file:
