...
#     category = os.path.join(results, dir)
#     for file in os.listdir(category):
#         fn = os.path.join(category, file)


with open('./results/generic_terms/generic_terms_IQ_2018-01-01-to-2023-05-31_adjusted.csv','rb') as f:
