...
This script will go through the downloaded unlabeled tweets to store it in a more parsable format. Currently, the tweets are stored
into separate json files. To avoid having to loop through all the city directories and their respective json files, this script
will store the tweet and all other necessary information into a csv file for easier labeling in the future. 
'''
